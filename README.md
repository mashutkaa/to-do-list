...
- **Масовий шеринг** — вибір однієї або кількох задач у модалці й надсилання **одного** email з деталями кожної задачі (Nodemailer / Brevo)
...
SMTP_FROM="To-Do List <noreply@example.com>"
```
